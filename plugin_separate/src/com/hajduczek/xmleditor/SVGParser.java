...
public class SVGParser {
	...
	public void parse() throws Exception {
		...
		System.out.println("SVGParser.parse1 duration: " + ((System.currentTimeMillis()-startTime)) + "ms");
		DocumentBuilder builder = fact.newDocumentBuilder();
		System.out.println("SVGParser.parse2 duration: " + ((System.currentTimeMillis()-startTime)) + "ms");
		InputStream is = new ByteArrayInputStream(svg.getBytes("UTF-8"));
		System.out.println("SVGParser.parse3 duration: " + ((System.currentTimeMillis()-startTime)) + "ms");
		Document doc = builder.parse(is);
		System.out.println("SVGParser.parse4 duration: " + ((System.currentTimeMillis()-startTime)) + "ms");
		DFS(doc, doc.getDocumentElement());
		
		System.out.println("SVGParser.parse finish: " + ((System.currentTimeMillis()-startTime)) + "ms");
	}
